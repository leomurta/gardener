...
{
	public List<String> tokenizeToStringArray(String str, String delimiters, List<String> tokens)
	{
		return tokenizeToStringArray(str, delimiters, tokens, true, true);
	}
	
	public List<String> tokenizeToStringArray(String str, String delimiters, List<String> tokens, boolean trimTokens, boolean ignoreEmptyTokens) {
	...
	public boolean match(String pattern, String str) {
		...
		List<String> patDirs = tokenizeToStringArray(pattern, this.pathSeparator, new ArrayList<String>());
		List<String> strDirs = tokenizeToStringArray(str, this.pathSeparator, new ArrayList<String>());
		...
		if (strIdxStart > strIdxEnd) {
			...
			if (patIdxStart == patIdxEnd && patDirs.get(patIdxStart).equals("*") &&
	...
	public String extractPathWithinPattern(String pattern, String path) {
		List<String> patternParts = tokenizeToStringArray(pattern, this.pathSeparator, new ArrayList<String>());
		List<String> pathParts = tokenizeToStringArray(path, this.pathSeparator, new ArrayList<String>());
