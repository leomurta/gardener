...
/**
 * It Represents a revision
 * I create it because I do not know if the revision going to be a long or a hexa.
 * @author Marcos
 *
 */
public class RevisionID implements Comparable<RevisionID>{
	 ...
	 * I do not implement the setNumber bacause I do not if it going to be a long or a hexa.
	 * @return
	 */
	 ...
	 * In this time, I think that a new revision should be generate by the RevisionID because 
	 * it is not responsibility of APIClient nor Workspace.
	 * Peharps it should be responsibility of APIServ, but i do not know.
	 * It too need a seed. If the revision going to be incremental, it shall use the last revision of serv.
	 * but it shall use the hex unique id, it shall used a time seed or similar.
	 * 
